...
<html lang="en">
  ...
  <div class="container mx-auto px-4">
    ...
    <!-- =========== Hero Section Start =========== -->
    <section
      class="relative bg-gray-200/40 bg-[url('{{ asset('images/9.png') }}')] bg-no-repeat bg-cover"
      id="home"
    >
      <div class="container">
        <div
          class="grid lg:grid-cols-2 grid-cols-1 gap-x-6 gap-y-10 items-center"
        >
          <div class="">
            <h1
          ...
          <div class="relative">
            <img
              ...
              class="md:h-[700px] lg:ms-auto mx-auto rounded-lg"
            />
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="grid lg:grid-cols-2 items-center gap-6">
          <div class="lg:ms-5 ms-8">
            ...
            <h2
              class="text-3xl md:text-4xl/tight font-semibold text-black mt-4"
            >
          ...
          <div class="flex items-center">
            <img
              ...
              class="h-[600px] rounded-xl mx-auto"
            />
          </div>
        </div>
      </div>
    ...
    <section id="blog" class="py-20">
      <div class="container">
        ...
        <div
          class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-6 mt-14 items-center"
        >
          <div class="bg-white rounded-xl border">
            ...
            <div class="flex py-6 px-6">
              <div>
                <a
                  href="#"
                  class="text-xl text-black font-semibold line-clamp-2"
                  >5 Common Myths About Writing a Will – Debunked!</a
                >
              ...
              src="{{ asset('images/user.png') }}"
                      class="h-10 w-10 me-4 rounded-full"
                      alt=""
                    />
                    <a
                      href="#"
            ...
            <div class="flex py-6 px-6">
              <div>
                <a
                  href="#"
                  class="text-xl text-black font-semibold line-clamp-2"
                  >How Digital Will Storage Protects Your Legacy</a
                >
                <p class="mt-4 mb-6 text-gray-500 leading-6">
            ...
            <div class="flex py-6 px-6">
              <div>
                <a
                  href="#"
                  class="text-xl text-black font-semibold line-clamp-2"
                  >10 Life Events That Signal It’s Time to Update Your Will</a
                >
                <p class="mt-4 mb-6 text-gray-500 leading-6">
