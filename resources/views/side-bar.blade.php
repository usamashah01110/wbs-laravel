    ...
    <div>
        ...
        <ul>
            <a href="{{ route('admin.dashboard') }}">
                <li id="dashboardLink" class="hover:bg-gray-700 px-4 flex items-center gap-4 cursor-pointer transition-all duration-300">
                    <i class="fas fa-tachometer-alt text-green-500 text-lg py-2"></i>
                    <span class="sidebar-text">Dashboard</span>
                </li>
            </a>
            <a href="{{ route('admin.profile') }}">
                <li id="myAccountLink" class="hover:bg-gray-700 px-4 flex items-center gap-4 cursor-pointer transition-all duration-300">
                    <i class="fas fa-user-circle text-blue-500 text-lg py-2"></i>
                    <span class="sidebar-text">My Account</span>
                </li>
            </a>
            <form method="POST" action="{{ route('logout') }}">
                <li id="logoutLink" class="hover:bg-gray-700 px-4 flex items-center gap-4 cursor-pointer transition-all duration-300">
