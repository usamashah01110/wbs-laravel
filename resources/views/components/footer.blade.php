        ...
        <div class="flex justify-between items-center w-11/12 mx-auto py-4">
            ...
            <div class="flex gap-2">
                <a  target="blank" class="p-2 text-sm font-semibold rounded-md text-white hover:bg-[#415a77] transition-all duration-300" href="https://www.facebook.com/profile.php?id=61571193345238">
                    ...
                    <img class="h-8 w-8" src="../../../public/images/facebook.png" alt="facebook icon">
                </a>
                ...
                <svg class="flex-shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="18" height="18" viewBox="0,0,256,256">
