                ...
                <section class="bg-white p-6 rounded-lg shadow">
                    <div class="flex justify-between mb-6">
                        ...
                        <div class="bg-white p-4 rounded-lg shadow w-1/3">
                            ...
                            <p
                                class="font-semibold {{ $user->subscription_status == 'active' ? 'text-green-500' : 'text-red-500' }}">
                                {{ ucfirst('Active') }}
                            </p>
                                ...
                                @forelse ($user->documents->where('documnet_type', 'will') as $doc)
                                    <div class="flex items-center justify-between bg-gray-100 p-2 rounded">
                                        ...
                                        <div class="flex items-center gap-4">
                                            <a href="{{ asset('storage/' . $doc->path) }}" class="text-green-500"
                                                target="_blank" download>
                                                <i class="fas fa-download"></i>
                                            </a>
                                            <a href="{{ asset('storage/' . $doc->path) }}" class="text-blue-500"
