        ...
        <div class="p-8 text-center">
          ...
          <div class="mt-8 space-y-4">
            <a
              ...
              class="w-full inline-block text-white bg-[#3A5F8F] py-3 rounded-lg font-medium hover:bg-[#f47d61] transition-all duration-300 ease-in-out"
            >
              Go to Dashboard
            </a>
            <a
              href="{{ url('/') }}"
              class="w-full inline-block text-[#3A5F8F] underline font-medium hover:text-[#f47d61] transition-all duration-300 ease-in-out"
            >
              Back to Homepage
            </a>
          </div>
